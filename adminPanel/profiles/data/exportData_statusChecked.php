...
$productResult = $db_handle->runQuery("select * from lib_pageVisits");
...
<h2 style="text-align:center;">Page Visits Data</h2>
<div id="table-container">
    <div class="btn">
        <button onclick="exportTableToExcel('tab', 'HULib-pageVisits')" id="btnExport" name='export'
    ...
    <table id="tab">
        ...
        <tbody>
            ...
            <?php
            $query = $db_handle->runQuery("select * from lib_pageVisits order by id desc");
            if (! empty($productResult)) {
                ...
                <td><?php echo $productResult[$key]["count"]; ?></td>
